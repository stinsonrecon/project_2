                ...
                <div class="border rounded-xl bg-white p-7 mb-10">
                    ...
                    <div class="mb-6 grid grid-cols-3 gap-4">
                        <div class="col-span-2">
                            ...
                            <input class="border border-gray-300 rounded outline-none text-black py-2.5 px-3 w-full text-sm"
                             id="gia" name="gia" type="number" min="1" placeholder="Nhập mức giá, VD 12000000" step="any" required>
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input datepicker datepicker-autohide datepicker-format="yyyy/mm/dd" type="text"
                                ...
                                id="startTime" name="startTime" value="{{ $current_time }}" required onchange="diffDay()">
                    </div>
                ...
                <div class="mb-4 border-b border-gray-400 pb-4">
                    ...
                    <div class="relative">
                        ...
                        <input datepicker datepicker-autohide datepicker-format="yyyy/mm/dd" type="text"
                                ...
                                leading-tight focus:outline-none focus:shadow-outline text-black block pl-10 p-2.5"
                                placeholder="Nhập ngày tháng năm sinh"
                                id="endTime" name="endTime" value="{{ $end_time }}" required onchange="diffDay()">
                    </div>
                    <script src="https://unpkg.com/@themesberg/flowbite@1.3.0/dist/datepicker.bundle.js"></script>
                </div>

                <div id="loai_tin_price" class="flex mb-4 text-black">
                    Đơn giá/ngày: <span id="price">{{ $loai_tin[0]->gia }}</span>
                </div>
