...
<html lang="en">
  <head>
    ...
    <title>Hệ thống quản lý bất động sản | Đăng nhập</title>
    <link
        ...
        <main>
          <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
            ...
            <form action="{{route('admin.login')}}" method="post" class="space-y-6">
              ...
              {{-- <div class="flex items-center justify-between">
                ...
                <label class="flex items-center">
                  ...
                  <span class="ml-3 text-sm font-normal text-gray-500 dark:text-gray-400">Nhớ mật khẩu</span>
                </label>
            ...
            <div class="text-sm text-gray-600 dark:text-gray-400">
              Chưa có tài khoản? <a href="{{route('admin.register')}}" class="text-blue-600 hover:underline">Đăng ký</a>
            </div>
          </div>
        </main>
      </div>
